...
Namespace DXSample
	Partial Public Class Main
		...
		Private Sub OnCustomDrawBarItemLink(ByVal sender As Object, ByVal e As CustomDrawBarItemEventArgs) Handles ribbonControl1.CustomDrawBarItemLink
			If TypeOf e.ItemLink Is BarSubItemLink Then
				e.Appearance.ForeColor = Color.Red
			End If
			If e.ItemLink.Item.Name = "barButtonItem1" Then
				...
				If e.ItemLink.ImageIndex <> -1 Then
					Dim image As Image = (TryCast(e.ItemLink.Item.Images, ImageCollection)).Images(e.ItemLink.ImageIndex)
					e.Cache.Graphics.DrawImage(image, e.GlyphBounds)
				End If
				e.Handled = True
			End If
			If e.ItemLink.Item.Name = "barEditItem1" Then
				If e.IsItemHotTracked Then
